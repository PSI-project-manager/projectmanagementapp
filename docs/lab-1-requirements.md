...
Goals:​
- [ ] Develop a web application using the material covered in 1-6 lectures.​
- [ ] Develop an app in ASP.NET that has basic functionality.​
- [ ] Understand the usage of GitHub, coding in team principles.​
- [ ] Prepare foundation for future work.​
- [ ] Learn to code review yourself and take the feedback when getting one.​

Formal Requirements:​

- [ ] Application can be interacted with using some sort of interface. There exists at least one user scenario, which can be demonstrated end to end. ​
